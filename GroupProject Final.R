...
save(c,file = "C:\\Users\\dkalapati\\Documents\\GitHub\\rishabhproject\\c.Rdata")



#users hastag word cloud
...
# Count occurrences of each term
b = sort(colSums(a),decreasing=TRUE)
d = data.frame(row.names=NULL,word = names(b),freq=b)
save(d,file = "C:\\Users\\dkalapati\\Documents\\GitHub\\rishabhproject\\d.Rdata")
